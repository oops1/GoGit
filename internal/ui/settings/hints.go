...
func (v *View) buildHints() {
	...
	addFieldHint(v.sectionGeneral, "Dialog.Settings.Layout.Hint", 7, 2)
	addGroupDescription(v.sectionGeneral, "Dialog.Settings.Group.Interface.Desc", 12)
	addCheckboxHint(v.sectionGeneral, "Dialog.Settings.ShowToolbar.Hint", 15)
