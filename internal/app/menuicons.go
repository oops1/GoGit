...
var commandIcons = map[CommandID]string{
	...
	CmdSubmoduleUpdate:     "update",
	CmdSubmoduleInitialize: "clone",
	CmdSubmoduleSync:       "sync",
	CmdSubmoduleAdd:        "repo_add",
...
var contextIcons = map[string]string{
	...
	"Menu.Remote.Submodule.Update":      "update",
	"Menu.Remote.Submodule.Initialize":  "clone",
	"Menu.Remote.Submodule.Synchronize": "sync",
	"Menu.Remote.Submodule.Remove":      "worktree_remove",
	"Menu.Remote.Submodule.Unregister":  "close_repo",
	"Menu.Remote.Submodule.Reset":       "reset",
}
