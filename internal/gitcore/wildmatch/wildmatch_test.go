...
func TestMatchFollowsGitPathnameRules(t *testing.T) {
	tests := []struct {
		...
		{"doubleStarInsideAComponentActsLikeAStar", "a**b", "axxb", false, true},
		{"doubleStarInsideAComponentStopsAtSlash", "a**b", "ax/xb", false, false},
		{"doubleStarAfterADirectoryActsLikeAStar", "logs/**.log", "logs/a.log", false, true},
		{"doubleStarFollowedByText", "**x", "ax", false, true},
